...
import com.sammy.favdish.databinding.FragmentDishDetailsBinding
...
//            mBinding!!.tvCookingDirection.text = it.dishDetails.directionToCook
        ...
        mBinding!!.ivFavoriteDish.setOnClickListener {
            ...
            if (args.dishDetails.favoriteDish) {
                ...
                Toast.makeText(
                    requireActivity(),
                    resources.getString(R.string.msg_added_to_favorites), Toast.LENGTH_SHORT
                ).show()
            } else {
                mBinding!!.ivFavoriteDish.setImageDrawable(
                    ContextCompat.getDrawable(
                ...
                Toast.makeText(
                    requireActivity(),
                    resources.getString(R.string.msg_removed_to_favorites), Toast.LENGTH_SHORT
                ).show()
